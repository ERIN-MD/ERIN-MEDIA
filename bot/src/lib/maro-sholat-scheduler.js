...
import { getTodaySchedule, extractPrayerTimes } from "./maro-sholat-api.js";
...
const LOCAL_PRAYER_IMAGE = config.assets?.["maro-landscape"] || config.assets?.maro || null;
const GAMBAR_SUASANA = Object.fromEntries(
  ["imsak", "subuh", "terbit", "dhuha", "dzuhur", "ashar", "maghrib", "isya"].map((name) => [name, LOCAL_PRAYER_IMAGE]),
);
