...
function normalizeAnswer(answer) {
    ...
    return answer
        .toLowerCase()
        .replace(/[^a-z0-9\u0621-\u064A\s]/gi, '') // دعم الحروف العربية
        .replace(/\s+/g, ' ')
        .trim();
}
...
function isSurrender(text) {
    ...
    const surrenderWords = [
        // كلمات الاستسلام بالعربية
        'استسلام', 'انسحاب', 'خروج', 'نستسلم', 'استسلم',
        'مش عارف', 'مش عارفة', 'معرفش', 'ماعرفش',
        // الكلمات الأصلية (للتوافق)
