...
// ⚠️ أمان/استقرار: كان هنا معالج `uncaughtException` يبتلع كل استثناء غير ملتقط
// في العملية بأكملها بصمت، فيجعل البوت (والاختبارات) يخرج بحالة نجاح رغم الانهيار.
// معالج الانهيار الرسمي موجود في index.js ويسجّل الخطأ؛ وحفظ الذاكرة المؤقتة
// مضمون عبر حدث "exit" الذي يعمل أيضاً بعد أي انهيار غير ملتقط.
 ...
 * Participant structure dari maro (groups.js):
