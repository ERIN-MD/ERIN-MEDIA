...
/**
 * @typedef {Object} MaroApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} MaroApiProviderShape
 * @property {string} baseURL
 * @property {MaroApiAuthShape} [auth]
...
/**
 * @typedef {Object} MaroApiRequestOptions
...
/**
 * @typedef {Object} MaroApiMultipartFile
 ...
 */
class MaroApiProvider {
  /**
   * @param {MaroApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {MaroApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {MaroApiMultipartFile[]|Object<string, any>} [files]
   * @param {MaroApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends MaroApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends MaroApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends MaroApiProvider {
...
class ApiFaaProvider extends MaroApiProvider {
...
class MaroMainApiProvider extends MaroApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends MaroApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends MaroApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends MaroApiProvider {
...
class AzbryApiProvider extends MaroApiProvider {
...
class YuulabsApiProvider extends MaroApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends MaroApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends MaroApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Maro.
 */
class MaroApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @param {MaroApiProviderShape} cfg
   * @returns {MaroApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<MaroApiProviderShape>} cfg
   * @returns {MaroApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || MaroApiProvider;
...
const maroApi = new MaroApiManager();

export { MaroApiManager, MaroApiProvider, maroApi };
export default maroApi;
